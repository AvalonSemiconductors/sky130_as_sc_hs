...
lctime --liberty template.lib --library "/foss/pdks/sky130A/libs.tech/combined/sky130.lib.spice ff" --output-loads "$2" --slew-times "$3" --spice $1.spice --cell $1 --output ./test.lib
